        ...
        <nav className="sup">
          ...
          <form className="form">
            <p className="text-center">
              ...
              <a href="#" onClick={showSignIn} className="text-warning stt">
                Sign IN
              </a>
            </p>
            <input
            ...
            <div className="d-flex">
              <input
                ...
                className="overflow-visible form-control mb-2 me-2"
                value={fname}
                onChange={(e) => {
                  setF(e.target.value);
                  handleChange();
            ...
            <button
              className="btn btn-primary mt-4 lecy"
              type="submit"
      ...
      <div className="right mx-5">
        <div className="py-5 px-4 about">
          ...
          <p>
            ...
            corporis quod dolorum ratione officia rem quae velit commodi.
            Impedit fugit nobis temporibus eos libero sed tempora ipsum, beatae
            hic veritatis!
          </p>
          <br />
