const { register, userById, getAllUsers, getUserByEmail, profile } = require('./user.service');
...
module.exports = {
    createUser: (req, res) => {
        ...
        //validation 
        if (!userName || !firstName || !lastName || !email || !password) return res.status(400).json({ msg: 'Not all fields have been provided!' });
